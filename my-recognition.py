...
# Add this code to parse the image file name and select a network.
parser = argparse.ArgumentParser()
parser.add_argument("filename", type=str, help="filename of the image to process")
parser.add_argument("--network", type=str, default="googlenet", help="model to use, can be:  googlenet, resnet-18, ect. (see --help for others)")
opt = parser.parse_args()

# Load the image from the disk using the loadImage function.
...
# Get the description for the class that the image belongs to.
class_desc = net.GetClassDesc(class_idx)

# Write a print statement to print out the information that you have gathered including the class index, class description, and confidence.
